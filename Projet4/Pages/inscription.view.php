 <?php 
	...
	echo $form->startForm("container col-md-offset-4 col-md-4 jumbotron spacer", "Formulaire Inscription", "index.php?Page=inscription");
	...
	echo $form->reset("Connexion", "index.php?Page=connexion");
